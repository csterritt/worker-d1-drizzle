...
const renderPrivate = (c: Context) => {
  return (
    <div data-testid='private-page-banner' className="flex flex-col items-center">
      <div className="card w-full max-w-md bg-base-100 shadow-xl mb-6">
        <div className="card-body">
          ...
          <p className="py-4">This is a protected area that requires authentication to access.</p>
