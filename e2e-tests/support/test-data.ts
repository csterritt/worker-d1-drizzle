...
export const ERROR_MESSAGES = {
  ...
  EMAIL_NOT_VERIFIED: 'Please verify your email address before signing in. Check your email for a verification link.',
  ...
  // Sign-up errors
  DUPLICATE_EMAIL: 'An account with this email already exists. Please check your email for a verification link or sign in if you have already verified your account.',
  INVALID_CODE: 'Invalid or expired sign-up code. Please check your code and try again.',
  
  // Interest sign-up messages
  WAITLIST_SUCCESS: "Thanks! You've been added to our waitlist. We'll notify you when we start accepting new accounts.",
  ALREADY_ON_WAITLIST: "Thanks! Your email is already on our waitlist. We'll notify you when we're accepting new accounts.",
