...
test.describe('Body size limit', () => {
  test('returns 413 status when JSON payload exceeds size limit', async ({
    page,
    request,
  }) => {
  ...
  test('returns 413 status when form data payload exceeds size limit', async ({
    page,
    request,
  }) => {
    // First sign in to get a valid session
  ...
  test('correctly handles payloads at the size limit boundary', async ({
    page,
    request,
  }) => {
    // First sign in to get a valid session
